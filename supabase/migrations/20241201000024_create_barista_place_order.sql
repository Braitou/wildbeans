-- Créer la fonction barista_place_order
-- Cette fonction permet au barista d'enregistrer rapidement des commandes au comptoir
-- Les commandes sont directement marquées comme "served"
...
-- Autorisation
grant execute on function public.barista_place_order(uuid, jsonb) to authenticated;
